...
# Load model
model = load_model("model_reg.h5", compile=False)

# Save in the new TF format (preferred)
#model.save("model_tf", save_format="tf")

#model = load_modeload_model("model_tf")
...
# Align columns with scaler's training features
